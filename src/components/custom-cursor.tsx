  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-4 w-4 rounded-full bg-primary shadow-[0_0_20px_var(--color-primary)] opacity-60" />
      </motion.div>
      
      {/* Global discovery overlay - subtle mask that the cursor "reveals" */}
      <motion.div
        style={{
          background: `radial-gradient(600px circle at ${sx.get()}px ${sy.get()}px, transparent 0%, var(--background) 100%)`,
        }}
